...
/*
output "this_random_master_password" {
  description = "random_master_password"
  value       = length(random_password.master_password) > 0 ? join("",random_password.master_password[0]) : ""
}
*/